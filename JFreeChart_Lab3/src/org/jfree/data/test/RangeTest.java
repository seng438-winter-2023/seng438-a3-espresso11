...
public void NegativeAndPositive() {
	Range range = new Range(-3.4, 4.1);
	String actual = range.toString();
	assertEquals("The string should match Range[-3.4,4.1]", "Range[-3.4,4.1]", actual);
}
...
public void PositiveAndPositive() {
	...
	String actual = range.toString();
	assertEquals("The string should match Range[3.0,5.0]", "Range[3.0,5.0]", actual);
}
...
public void NegativeAndNegative() {
	Range range = new Range(-8.2, -1.1);
	String actual = range.toString();
	assertEquals("The string should match Range[-8.2,-1.1]", "Range[-8.2,-1.1]", actual);
}
